...
data_path = "/dataset/Dataset/UIT-ViIC/train/images/"
img_list = os.listdir(data_path)
tsv_file = "/dataset/Dataset/Vietnamese-COCO/train.tsv"
label_file = "/dataset/Dataset/Vietnamese-COCO/train.label.tsv"
hw_file = "/dataset/Dataset/Vietnamese-COCO/train.hw.tsv"
linelist_file = "/dataset/Dataset/Vietnamese-COCO/train.linelist.tsv"
...
# rows = tsv_reader("/dataset/train.tsv")
...
tsv = TSVFile(
    "/dataset/Dataset/Merge_data/train.feature.tsv", generate_lineidx=True)
